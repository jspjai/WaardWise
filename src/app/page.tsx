    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <Alert variant="destructive" className="max-w-md bg-white border-red-100 shadow-xl rounded-2xl">
          ...
          <AlertTitle className="font-headline font-bold text-red-600">Configuration Missing</AlertTitle>
          <AlertDescription className="mt-2 text-slate-600 text-sm leading-relaxed">
            Firebase API keys are not detected. Please add your configuration to the <code className="bg-slate-100 px-1.5 py-0.5 rounded text-red-500">.env</code> file or the Project Settings to enable Intelligence services.
          </AlertDescription>
        </Alert>
      </div>
    );
